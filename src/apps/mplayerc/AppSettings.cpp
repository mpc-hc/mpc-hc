	...
	, fShowDebugInfo(false)
{
	...
	DXVAFiltersKeys[TRA_DXVA_WMV9] = _T("TRA_DXVA_WMV9");
#endif
...
#define ADDCMD(cmd) wmcmds.AddTail(wmcmd##cmd)
	...
	//ADDCMD((ID_COLOR_HUE_INC,					  0, FVIRTKEY|FNOINVERT,				IDS_HUE_INC)); // function does not need anybody
	//ADDCMD((ID_COLOR_HUE_DEC,					  0, FVIRTKEY|FNOINVERT,				IDS_HUE_DEC)); // function does not need anybody
