...
#define ADDCMD(cmd) wmcmds.AddTail(wmcmd##cmd)
	...
	ADDCMD((ID_VIEW_FULLSCREEN,			  VK_RETURN, FVIRTKEY|FALT|FNOINVERT,			IDS_AG_FULLSCREEN, 0, wmcmd::LDBLCLK));
	ADDCMD((ID_VIEW_FULLSCREEN_SECONDARY, VK_RETURN, FVIRTKEY|FCONTROL|FNOINVERT,		IDS_MPLAYERC_39));
