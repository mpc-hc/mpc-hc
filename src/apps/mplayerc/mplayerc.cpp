...
void CMPlayerCApp::Settings::CreateCmdName()
{
	cmd_name.RemoveAll();

	cmd_name.Add(ResStr(IDS_MPLAYERC_0));
	cmd_name.Add(ResStr(IDS_AG_OPEN_FILE));
	cmd_name.Add(ResStr(IDS_AG_OPEN_DVD));
	cmd_name.Add(ResStr(IDS_AG_OPEN_DEVICE));
	cmd_name.Add(ResStr(IDS_AG_SAVE_AS));
	cmd_name.Add(ResStr(IDS_AG_SAVE_IMAGE));
	cmd_name.Add(ResStr(IDS_MPLAYERC_6));
	cmd_name.Add(ResStr(IDS_AG_LOAD_SUBTITLE));
	cmd_name.Add(ResStr(IDS_AG_SAVE_SUBTITLE));
	cmd_name.Add(ResStr(IDS_AG_CLOSE));
	cmd_name.Add(ResStr(IDS_AG_PROPERTIES));
	cmd_name.Add(ResStr(IDS_AG_EXIT));
	cmd_name.Add(ResStr(IDS_AG_PLAYPAUSE));
	cmd_name.Add(ResStr(IDS_AG_PLAY));
	cmd_name.Add(_T("Pause"));
	cmd_name.Add(ResStr(IDS_AG_STOP));
	cmd_name.Add(ResStr(IDS_AG_FRAMESTEP));
	cmd_name.Add(ResStr(IDS_MPLAYERC_16));
	cmd_name.Add(ResStr(IDS_AG_GO_TO));
	cmd_name.Add(ResStr(IDS_AG_INCREASE_RATE));
	cmd_name.Add(ResStr(IDS_AG_DECREASE_RATE));
	cmd_name.Add(ResStr(IDS_AG_RESET_RATE));
	cmd_name.Add(ResStr(IDS_MPLAYERC_21));
	cmd_name.Add(ResStr(IDS_MPLAYERC_22));
	cmd_name.Add(ResStr(IDS_MPLAYERC_23));
	cmd_name.Add(ResStr(IDS_MPLAYERC_24));
	cmd_name.Add(ResStr(IDS_MPLAYERC_25));
	cmd_name.Add(ResStr(IDS_MPLAYERC_26));
	cmd_name.Add(ResStr(IDS_MPLAYERC_27));
	cmd_name.Add(ResStr(IDS_MPLAYERC_28));
	cmd_name.Add(ResStr(IDS_MPLAYERC_29));
	cmd_name.Add(ResStr(IDS_MPLAYERC_30));
	cmd_name.Add(ResStr(IDS_AG_NEXT));
	cmd_name.Add(ResStr(IDS_AG_PREVIOUS));
	cmd_name.Add(ResStr(IDS_MPLAYERC_33));
	cmd_name.Add(ResStr(IDS_MPLAYERC_34));
	cmd_name.Add(_T("Toggle Caption&Menu"));
	cmd_name.Add(_T("Toggle Seeker"));
	cmd_name.Add(_T("Toggle Controls"));
	cmd_name.Add(_T("Toggle Information"));
	cmd_name.Add(_T("Toggle Statistics"));
	cmd_name.Add(_T("Toggle Status"));
	cmd_name.Add(_T("Toggle Subresync Bar"));
	cmd_name.Add(_T("Toggle Playlist Bar"));
	cmd_name.Add(_T("Toggle Capture Bar"));
	cmd_name.Add(_T("Toggle Shader Editor Bar"));
	cmd_name.Add(ResStr(IDS_AG_VIEW_MINIMAL));
	cmd_name.Add(ResStr(IDS_AG_VIEW_COMPACT));
	cmd_name.Add(ResStr(IDS_AG_VIEW_NORMAL));
	cmd_name.Add(ResStr(IDS_AG_FULLSCREEN));
	cmd_name.Add(ResStr(IDS_MPLAYERC_39));
	cmd_name.Add(_T("Zoom 50%"));
	cmd_name.Add(_T("Zoom 100%"));
	cmd_name.Add(_T("Zoom 200%"));
	cmd_name.Add(ResStr(IDS_AG_ZOOM_AUTO_FIT));	
	cmd_name.Add(_T("Next AR Preset"));
	cmd_name.Add(ResStr(IDS_AG_VIDFRM_HALF));
	cmd_name.Add(ResStr(IDS_AG_VIDFRM_NORMAL));
	cmd_name.Add(ResStr(IDS_AG_VIDFRM_DOUBLE));
	cmd_name.Add(_T("VidFrm Stretch"));
	cmd_name.Add(_T("VidFrm Inside"));
	cmd_name.Add(_T("VidFrm Outside"));
	cmd_name.Add(ResStr(IDS_AG_ALWAYS_ON_TOP));
	cmd_name.Add(_T("PnS Reset"));
	cmd_name.Add(ResStr(IDS_AG_PNS_INC_SIZE));
	cmd_name.Add(ResStr(IDS_AG_PNS_INC_WIDTH));
	cmd_name.Add(ResStr(IDS_MPLAYERC_47));
	cmd_name.Add(ResStr(IDS_AG_PNS_DEC_SIZE));
	cmd_name.Add(ResStr(IDS_AG_PNS_DEC_WIDTH));
	cmd_name.Add(ResStr(IDS_MPLAYERC_50));
	cmd_name.Add(ResStr(IDS_AG_PNS_CENTER));
	cmd_name.Add(ResStr(IDS_AG_PNS_LEFT));
	cmd_name.Add(ResStr(IDS_AG_PNS_RIGHT));
	cmd_name.Add(ResStr(IDS_AG_PNS_UP));
	cmd_name.Add(ResStr(IDS_AG_PNS_DOWN));
	cmd_name.Add(ResStr(IDS_AG_PNS_UPLEFT));
	cmd_name.Add(ResStr(IDS_AG_PNS_UPRIGHT));
	cmd_name.Add(ResStr(IDS_AG_PNS_DOWNLEFT));
	cmd_name.Add(ResStr(IDS_MPLAYERC_59));
	cmd_name.Add(_T("PnS Rotate X+"));
	cmd_name.Add(_T("PnS Rotate X-"));
	cmd_name.Add(_T("PnS Rotate Y+"));
	cmd_name.Add(_T("PnS Rotate Y-"));
	cmd_name.Add(_T("PnS Rotate Z+"));
	cmd_name.Add(_T("PnS Rotate Z-"));
	cmd_name.Add(ResStr(IDS_AG_VOLUME_UP));
	cmd_name.Add(ResStr(IDS_AG_VOLUME_DOWN));
	cmd_name.Add(ResStr(IDS_AG_VOLUME_MUTE));
	cmd_name.Add(ResStr(IDS_VOLUME_BOOST_INC));
	cmd_name.Add(ResStr(IDS_VOLUME_BOOST_DEC));
	cmd_name.Add(ResStr(IDS_VOLUME_BOOST_MIN));
	cmd_name.Add(ResStr(IDS_VOLUME_BOOST_MAX));

	cmd_name.Add(ResStr(IDS_MPLAYERC_63));
	cmd_name.Add(ResStr(IDS_AG_DVD_ROOT_MENU));
	cmd_name.Add(ResStr(IDS_MPLAYERC_65));
	cmd_name.Add(ResStr(IDS_MPLAYERC_66));
	cmd_name.Add(ResStr(IDS_MPLAYERC_67));
	cmd_name.Add(ResStr(IDS_MPLAYERC_68));
	cmd_name.Add(ResStr(IDS_AG_DVD_MENU_LEFT));
	cmd_name.Add(ResStr(IDS_MPLAYERC_70));
	cmd_name.Add(ResStr(IDS_AG_DVD_MENU_UP));
	cmd_name.Add(ResStr(IDS_AG_DVD_MENU_DOWN));
	cmd_name.Add(ResStr(IDS_MPLAYERC_73));
	cmd_name.Add(ResStr(IDS_AG_DVD_MENU_BACK));
	cmd_name.Add(ResStr(IDS_MPLAYERC_75));
	cmd_name.Add(ResStr(IDS_AG_BOSS_KEY));
	cmd_name.Add(ResStr(IDS_MPLAYERC_77));
	cmd_name.Add(ResStr(IDS_MPLAYERC_78));
	cmd_name.Add(ResStr(IDS_AG_FILTERS_MENU));
	cmd_name.Add(ResStr(IDS_AG_OPTIONS));
	cmd_name.Add(ResStr(IDS_AG_NEXT_AUDIO));
	cmd_name.Add(ResStr(IDS_AG_PREV_AUDIO));
	cmd_name.Add(ResStr(IDS_AG_NEXT_SUBTITLE));
	cmd_name.Add(ResStr(IDS_AG_PREV_SUBTITLE));
	cmd_name.Add(ResStr(IDS_MPLAYERC_85));
	cmd_name.Add(ResStr(IDS_MPLAYERC_86));
	cmd_name.Add(ResStr(IDS_MPLAYERC_87));
	cmd_name.Add(ResStr(IDS_MPLAYERC_88));
	cmd_name.Add(ResStr(IDS_MPLAYERC_89));
	cmd_name.Add(ResStr(IDS_MPLAYERC_90));
	cmd_name.Add(ResStr(IDS_MPLAYERC_91));
	cmd_name.Add(ResStr(IDS_MPLAYERC_92));
	cmd_name.Add(ResStr(IDS_MPLAYERC_93));
	cmd_name.Add(ResStr(IDS_MPLAYERC_94));
	cmd_name.Add(ResStr(IDS_MPLAYERC_95));
	cmd_name.Add(ResStr(IDS_MPLAYERC_96));
	cmd_name.Add(ResStr(IDS_MPLAYERC_97));

	// === CASIMIR666 : nouveau shortcuts
	cmd_name.Add(_T("Tearing Test"));
	cmd_name.Add(ResStr(IDS_MPLAYERC_98));
	cmd_name.Add(_T("Toggle Pixel Shader"));
	cmd_name.Add(ResStr(IDS_MPLAYERC_99));
	cmd_name.Add(ResStr(IDS_MPLAYERC_100));
	cmd_name.Add(ResStr(IDS_MPLAYERC_101));
	cmd_name.Add(ResStr(IDS_MPLAYERC_102));
	cmd_name.Add(ResStr(IDS_MPLAYERC_103));
	cmd_name.Add(ResStr(IDS_AG_DISPLAY_STATS));
	cmd_name.Add(ResStr(IDS_MPLAYERC_104));
	cmd_name.Add(ResStr(IDS_MPLAYERC_105));
	cmd_name.Add(ResStr(IDS_FILE_SAVE_THUMBNAILS));
}

CString CMPlayerCApp::Settings::GetCmdName(int i)
{
	if((i<0) || (i>=cmd_name.GetCount())) return(_T(""));
	return(cmd_name.GetAt(i));
}
...
#define ADDCMD(cmd) wmcmds.AddTail(wmcmd##cmd)
	ADDCMD((ID_FILE_OPENQUICK, 'Q', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_0)*/));
	ADDCMD((ID_FILE_OPENMEDIA, 'O', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_OPEN_FILE)*/));
	ADDCMD((ID_FILE_OPENDVD, 'D', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_OPEN_DVD)*/));
	ADDCMD((ID_FILE_OPENDEVICE, 'V', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_OPEN_DEVICE)*/));
	ADDCMD((ID_FILE_SAVE_COPY, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_SAVE_AS)*/));
	ADDCMD((ID_FILE_SAVE_IMAGE, 'I', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_SAVE_IMAGE)*/));
	ADDCMD((ID_FILE_SAVE_IMAGE_AUTO, VK_F5, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_6)*/));
	ADDCMD((ID_FILE_LOAD_SUBTITLE, 'L', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_LOAD_SUBTITLE)*/));
	ADDCMD((ID_FILE_SAVE_SUBTITLE, 'S', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_SAVE_SUBTITLE)*/));
	ADDCMD((ID_FILE_CLOSEPLAYLIST, 'C', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_CLOSE)*/));
	ADDCMD((ID_FILE_PROPERTIES, VK_F10, FVIRTKEY|FSHIFT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PROPERTIES)*/));
	ADDCMD((ID_FILE_EXIT, 'X', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_EXIT)*/));
	ADDCMD((ID_PLAY_PLAYPAUSE, VK_SPACE, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PLAYPAUSE)*/, APPCOMMAND_MEDIA_PLAY_PAUSE, wmcmd::LDOWN));
	ADDCMD((ID_PLAY_PLAY, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PLAY)*/));
	ADDCMD((ID_PLAY_PAUSE, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*_T("Pause")*/));
	ADDCMD((ID_PLAY_STOP, VK_OEM_PERIOD, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_STOP)*/, APPCOMMAND_MEDIA_STOP));
	ADDCMD((ID_PLAY_FRAMESTEP, VK_RIGHT, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_FRAMESTEP)*/));
	ADDCMD((ID_PLAY_FRAMESTEPCANCEL, VK_LEFT, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_16)*/));
	ADDCMD((ID_PLAY_GOTO, 'G', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_GO_TO)*/));
	ADDCMD((ID_PLAY_INCRATE, VK_UP, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_INCREASE_RATE)*/));
	ADDCMD((ID_PLAY_DECRATE, VK_DOWN, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_DECREASE_RATE)*/));
	ADDCMD((ID_PLAY_RESETRATE, 'R', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_RESET_RATE)*/));
	ADDCMD((ID_PLAY_INCAUDDELAY, VK_ADD, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_21)*/));
	ADDCMD((ID_PLAY_DECAUDDELAY, VK_SUBTRACT, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_22)*/));
	ADDCMD((ID_PLAY_SEEKFORWARDSMALL, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_23)*/));
	ADDCMD((ID_PLAY_SEEKBACKWARDSMALL, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_24)*/));
	ADDCMD((ID_PLAY_SEEKFORWARDMED, VK_RIGHT, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_25)*/));
	ADDCMD((ID_PLAY_SEEKBACKWARDMED, VK_LEFT, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_26)*/));
	ADDCMD((ID_PLAY_SEEKFORWARDLARGE, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_27)*/));
	ADDCMD((ID_PLAY_SEEKBACKWARDLARGE, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_28)*/));
	ADDCMD((ID_PLAY_SEEKKEYFORWARD, VK_RIGHT, FVIRTKEY|FSHIFT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_29)*/));
	ADDCMD((ID_PLAY_SEEKKEYBACKWARD, VK_LEFT, FVIRTKEY|FSHIFT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_30)*/));
	ADDCMD((ID_NAVIGATE_SKIPFORWARD, VK_NEXT, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_NEXT)*/, APPCOMMAND_MEDIA_NEXTTRACK, wmcmd::X2DOWN));
	ADDCMD((ID_NAVIGATE_SKIPBACK, VK_PRIOR, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PREVIOUS)*/, APPCOMMAND_MEDIA_PREVIOUSTRACK, wmcmd::X1DOWN));
	ADDCMD((ID_NAVIGATE_SKIPFORWARDPLITEM, VK_NEXT, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_33)*/));
	ADDCMD((ID_NAVIGATE_SKIPBACKPLITEM, VK_PRIOR, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_34)*/));
	ADDCMD((ID_VIEW_CAPTIONMENU, '0', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Caption&Menu")*/));
	ADDCMD((ID_VIEW_SEEKER, '1', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Seeker")*/));
	ADDCMD((ID_VIEW_CONTROLS, '2', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Controls")*/));
	ADDCMD((ID_VIEW_INFORMATION, '3', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Information")*/));
	ADDCMD((ID_VIEW_STATISTICS, '4', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Statistics")*/));
	ADDCMD((ID_VIEW_STATUS, '5', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Status")));
	ADDCMD((ID_VIEW_SUBRESYNC, '6', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Subresync Bar")*/));
	ADDCMD((ID_VIEW_PLAYLIST, '7', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Playlist Bar")*/));
	ADDCMD((ID_VIEW_CAPTURE, '8', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Capture Bar")*/));
	ADDCMD((ID_VIEW_SHADEREDITOR, '9', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Shader Editor Bar")*/));
	ADDCMD((ID_VIEW_PRESETS_MINIMAL, '1', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VIEW_MINIMAL)*/));
	ADDCMD((ID_VIEW_PRESETS_COMPACT, '2', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VIEW_COMPACT)*/));
	ADDCMD((ID_VIEW_PRESETS_NORMAL, '3', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VIEW_NORMAL)*/));
	ADDCMD((ID_VIEW_FULLSCREEN, VK_F11, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_FULLSCREEN)*/, 0, wmcmd::LDBLCLK));
	ADDCMD((ID_VIEW_FULLSCREEN_SECONDARY, VK_RETURN, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_39)*/));
	ADDCMD((ID_VIEW_ZOOM_50, '1', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("Zoom 50%")*/));
	ADDCMD((ID_VIEW_ZOOM_100, '2', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("Zoom 100%")*/));
	ADDCMD((ID_VIEW_ZOOM_200, '3', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("Zoom 200%")*/));
	ADDCMD((ID_VIEW_ZOOM_AUTOFIT, '4', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_ZOOM_AUTO_FIT)*/));	
	ADDCMD((ID_ASPECTRATIO_NEXT, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*_T("Next AR Preset")*/));
	ADDCMD((ID_VIEW_VF_HALF, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VIDFRM_HALF)*/));
	ADDCMD((ID_VIEW_VF_NORMAL, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VIDFRM_NORMAL)*/));
	ADDCMD((ID_VIEW_VF_DOUBLE, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VIDFRM_DOUBLE)*/));
	ADDCMD((ID_VIEW_VF_STRETCH, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*_T("VidFrm Stretch")*/));
	ADDCMD((ID_VIEW_VF_FROMINSIDE, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*_T("VidFrm Inside")*/));
	ADDCMD((ID_VIEW_VF_FROMOUTSIDE, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*_T("VidFrm Outside")*/));
	ADDCMD((ID_ONTOP_ALWAYS, 'A', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_ALWAYS_ON_TOP)*/));
	ADDCMD((ID_VIEW_RESET, VK_NUMPAD5, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*_T("PnS Reset")*/));
	ADDCMD((ID_VIEW_INCSIZE, VK_NUMPAD9, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_INC_SIZE)*/));
	ADDCMD((ID_VIEW_INCWIDTH, VK_NUMPAD6, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_INC_WIDTH)*/));
	ADDCMD((ID_VIEW_INCHEIGHT, VK_NUMPAD8, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_47)*/));
	ADDCMD((ID_VIEW_DECSIZE, VK_NUMPAD1, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_DEC_SIZE)*/));
	ADDCMD((ID_VIEW_DECWIDTH, VK_NUMPAD4, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_DEC_WIDTH)*/));
	ADDCMD((ID_VIEW_DECHEIGHT, VK_NUMPAD2, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_50)*/));
	ADDCMD((ID_PANSCAN_CENTER, VK_NUMPAD5, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_CENTER)*/));
	ADDCMD((ID_PANSCAN_MOVELEFT, VK_NUMPAD4, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_LEFT)*/));
	ADDCMD((ID_PANSCAN_MOVERIGHT, VK_NUMPAD6, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_RIGHT)*/));
	ADDCMD((ID_PANSCAN_MOVEUP, VK_NUMPAD8, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_UP)*/));
	ADDCMD((ID_PANSCAN_MOVEDOWN, VK_NUMPAD2, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_DOWN)*/));
	ADDCMD((ID_PANSCAN_MOVEUPLEFT, VK_NUMPAD7, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_UPLEFT)*/));
	ADDCMD((ID_PANSCAN_MOVEUPRIGHT, VK_NUMPAD9, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_UPRIGHT)*/));
	ADDCMD((ID_PANSCAN_MOVEDOWNLEFT, VK_NUMPAD1, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PNS_DOWNLEFT)*/));
	ADDCMD((ID_PANSCAN_MOVEDOWNRIGHT, VK_NUMPAD3, FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_59)*/));
	ADDCMD((ID_PANSCAN_ROTATEXP, VK_NUMPAD8, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("PnS Rotate X+")*/));
	ADDCMD((ID_PANSCAN_ROTATEXM, VK_NUMPAD2, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("PnS Rotate X-")*/));
	ADDCMD((ID_PANSCAN_ROTATEYP, VK_NUMPAD4, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("PnS Rotate Y+")*/));
	ADDCMD((ID_PANSCAN_ROTATEYM, VK_NUMPAD6, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("PnS Rotate Y-")*/));
	ADDCMD((ID_PANSCAN_ROTATEZP, VK_NUMPAD1, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("PnS Rotate Z+")*/));
	ADDCMD((ID_PANSCAN_ROTATEZM, VK_NUMPAD3, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*_T("PnS Rotate Z-")*/));
	ADDCMD((ID_VOLUME_UP, VK_UP, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VOLUME_UP)*/, APPCOMMAND_VOLUME_UP, wmcmd::WUP));
	ADDCMD((ID_VOLUME_DOWN, VK_DOWN, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VOLUME_DOWN)*/, APPCOMMAND_VOLUME_DOWN, wmcmd::WDOWN));
	ADDCMD((ID_VOLUME_MUTE, 'M', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_VOLUME_MUTE)*/, APPCOMMAND_VOLUME_MUTE));
	ADDCMD((ID_VOLUME_BOOST_INC, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_VOLUME_BOOST_INC)*/));
	ADDCMD((ID_VOLUME_BOOST_DEC, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_VOLUME_BOOST_DEC)*/));
	ADDCMD((ID_VOLUME_BOOST_MIN, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_VOLUME_BOOST_MIN)*/));
	ADDCMD((ID_VOLUME_BOOST_MAX, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_VOLUME_BOOST_MAX)*/));

	ADDCMD((ID_NAVIGATE_TITLEMENU, 'T', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_63)*/));
	ADDCMD((ID_NAVIGATE_ROOTMENU, 'R', FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_DVD_ROOT_MENU)*/));
	ADDCMD((ID_NAVIGATE_SUBPICTUREMENU, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_65)*/));
	ADDCMD((ID_NAVIGATE_AUDIOMENU, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_66)*/));
	ADDCMD((ID_NAVIGATE_ANGLEMENU, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_67)*/));
	ADDCMD((ID_NAVIGATE_CHAPTERMENU, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_68)*/));
	ADDCMD((ID_NAVIGATE_MENU_LEFT, VK_LEFT, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_DVD_MENU_LEFT)*/));
	ADDCMD((ID_NAVIGATE_MENU_RIGHT, VK_RIGHT, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_70)*/));
	ADDCMD((ID_NAVIGATE_MENU_UP, VK_UP, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_DVD_MENU_UP)*/));
	ADDCMD((ID_NAVIGATE_MENU_DOWN, VK_DOWN, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_DVD_MENU_DOWN)*/));
	ADDCMD((ID_NAVIGATE_MENU_ACTIVATE, VK_SPACE, FVIRTKEY|FALT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_73)*/));
	ADDCMD((ID_NAVIGATE_MENU_BACK, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_DVD_MENU_BACK)*/));
	ADDCMD((ID_NAVIGATE_MENU_LEAVE, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_75)*/));
	ADDCMD((ID_BOSS, 'B', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_BOSS_KEY)*/));
	ADDCMD((ID_MENU_PLAYER_SHORT, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_77)*/, 0, wmcmd::RUP));
	ADDCMD((ID_MENU_PLAYER_LONG, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_78)*/));
	ADDCMD((ID_MENU_FILTERS, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_FILTERS_MENU)*/));
	ADDCMD((ID_VIEW_OPTIONS, 'O', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_OPTIONS)*/));
	ADDCMD((ID_STREAM_AUDIO_NEXT, 'A', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_NEXT_AUDIO)*/));
	ADDCMD((ID_STREAM_AUDIO_PREV, 'A', FVIRTKEY|FSHIFT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PREV_AUDIO)*/));
	ADDCMD((ID_STREAM_SUB_NEXT, 'S', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_NEXT_SUBTITLE)*/));
	ADDCMD((ID_STREAM_SUB_PREV, 'S', FVIRTKEY|FSHIFT|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_PREV_SUBTITLE)*/));
	ADDCMD((ID_STREAM_SUB_ONOFF, 'W', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_85)*/));
	ADDCMD((ID_SUBTITLES_SUBITEM_START+2, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_86)*/));
	ADDCMD((ID_OGM_AUDIO_NEXT, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_87)*/));
	ADDCMD((ID_OGM_AUDIO_PREV, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_88)*/));
	ADDCMD((ID_OGM_SUB_NEXT, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_89)*/));
	ADDCMD((ID_OGM_SUB_PREV, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_90)*/));
	ADDCMD((ID_DVD_ANGLE_NEXT, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_91)*/));
	ADDCMD((ID_DVD_ANGLE_PREV, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_92)*/));
	ADDCMD((ID_DVD_AUDIO_NEXT, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_93)*/));
	ADDCMD((ID_DVD_AUDIO_PREV, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_94)*/));
	ADDCMD((ID_DVD_SUB_NEXT, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_95)*/));
	ADDCMD((ID_DVD_SUB_PREV, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_96)*/));
	ADDCMD((ID_DVD_SUB_ONOFF, 0, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_97)*/));

	// === CASIMIR666 : nouveau shortcuts
	ADDCMD((ID_VIEW_TEARING_TEST, 'T', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Tearing Test")*/));
	ADDCMD((ID_VIEW_REMAINING_TIME, 'I', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_98)*/));
	ADDCMD((ID_SHADER_TOGGLE, 'P', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*_T("Toggle Pixel Shader")*/));
	ADDCMD((ID_D3DFULLSCREEN_TOGGLE, 'F', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_99)*/));
	ADDCMD((ID_GOTO_PREV_SUB, 'Y', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_100)*/, APPCOMMAND_BROWSER_BACKWARD));
	ADDCMD((ID_GOTO_NEXT_SUB, 'U', FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_101)*/,  APPCOMMAND_BROWSER_FORWARD));
	ADDCMD((ID_SHIFT_SUB_DOWN, VK_NEXT, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_102)*/));
	ADDCMD((ID_SHIFT_SUB_UP, VK_PRIOR,   FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_103)*/));
	ADDCMD((ID_VIEW_DISPLAYSTATS, 'J', FVIRTKEY|FCONTROL|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_AG_DISPLAY_STATS)*/));
	ADDCMD((ID_SUB_DELAY_DOWN, VK_F1, FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_104)*/));
	ADDCMD((ID_SUB_DELAY_UP, VK_F2,   FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_MPLAYERC_105)*/));
	ADDCMD((ID_FILE_SAVE_THUMBNAILS, 0,   FVIRTKEY|FNOINVERT, GetCmdName(i++)/*ResStr(IDS_FILE_SAVE_THUMBNAILS)*/));
