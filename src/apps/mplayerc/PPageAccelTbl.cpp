...
//	case VK_OEM_NEC_EQUAL: str = _T("VK_OEM_NEC_EQUAL"); break;
	...
	case VK_OEM_CLEAR:
		str = _T("VK_OEM_CLEAR");
		break;
	case 0x07: case 0x0E: case 0x0F: case 0x16: case 0x1A: 
	case 0x3A: case 0x3B: case 0x3C: case 0x3D: case 0x3E:
	case 0x3F: case 0x40: 
		str.Format(_T("Undefined (0x%02x)"), (TCHAR)key);
		break;
	case 0x0A: case 0x0B: case 0x5E: case 0xB8: case 0xB9:
	...
	case 0xD5: case 0xD6: case 0xD7: case 0xE0: 
		str.Format(_T("Reserved (0x%02x)"), (TCHAR)key);
		break;
	case 0x88: case 0x89: case 0x8A: case 0x8B: case 0x8C:
	case 0x8D: case 0x8E: case 0x8F: case 0x97: case 0x98:
	case 0x99: case 0x9A: case 0x9B: case 0x9C: case 0x9D:
	case 0x9E: case 0x9F: case 0xD8: case 0xD9: case 0xDA:
	case 0xE8:
