...
#define INTERNAL_DECODER_WMV9_DXVA      1
...
#define HAS_FFMPEG_AUDIO_DECODERS \
		(INTERNAL_DECODER_AC3|INTERNAL_DECODER_AAC|INTERNAL_DECODER_MPEGAUDIO|INTERNAL_DECODER_VORBIS|\
		INTERNAL_DECODER_NELLYMOSER|INTERNAL_DECODER_AMR|INTERNAL_DECODER_ADPCM|INTERNAL_DECODER_REALAUDIO)
...
#define HAS_FFMPEG_VIDEO_DECODERS \
		...
		INTERNAL_DECODER_MJPEG|INTERNAL_DECODER_INDEO|INTERNAL_DECODER_REALVIDEO)

#define HAS_FFMPEG_DECODERS \
		(HAS_FFMPEG_AUDIO_DECODERS|HAS_FFMPEG_VIDEO_DECODERS)

#define HAS_DXVA_VIDEO_DECODERS \
		(INTERNAL_DECODER_H264_DXVA|INTERNAL_DECODER_VC1_DXVA|INTERNAL_DECODER_MPEG2_DXVA|INTERNAL_DECODER_WMV9_DXVA)
