...
#define IDS_RS_COLOR_BRIGHTNESS				_T("Color Brightness")
#define IDS_RS_COLOR_CONTRAST				_T("Color Contrast")
#define IDS_RS_COLOR_HUE					_T("Color Hue")
#define IDS_RS_COLOR_SATURATION				_T("Color Saturation")
