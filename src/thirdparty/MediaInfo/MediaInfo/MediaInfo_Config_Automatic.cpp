...
void MediaInfo_Config_Format (InfoMap &Info)
{
    ...
    "SubRip;;;T;Other;;srt;;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow;Lossless\n"
...
void MediaInfo_Config_General (ZtringListList &Info)
{
    ...
    "StreamOrder;;;N NI;;;Stream order in the file, whatever is the kind of stream (base=0)\n"
    "FirstPacketOrder;;;N NI;;;Order of the first fully decodable packet met in the file, whatever is the kind of stream (base=0)\n"
    ...
    "CompleteName_Last;;;Y NT;;;Complete name (Folder+Name+Extension) of the last file (in the case of a sequence of files)\n"
    ...
    "CodecID;;;Y NT;;;Codec ID (found in some containers);\n"
