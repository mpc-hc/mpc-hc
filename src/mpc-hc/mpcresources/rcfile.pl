...
foreach my $filename(@FileLists) {
    ...
    writeData(\@newrc, \@patches, \@curOutline, $curDialogs, $curMenus, $curStrings, \@curVersionInfo, $curDesignInfo);
...
sub writeData {
    ...
    my ($curOutline, $curDialogs, $curMenus, $curStrings, $curVersionInfo, $curDesignInfo) = @_;
