...
{
    auto languageResource = Translations::GetLanguageResourceByLocaleID(GetUserDefaultUILanguage());
...
bool CMPlayerCApp::SetLanguage(const Translations::LanguageResource& languageResource, bool showErrorMsg /*= true*/)
{
