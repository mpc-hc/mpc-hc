...
bool CMpegSplitterSettingsWnd::OnActivate()
{
	...
	nPosY += VERTICAL_SPACING - 5;
	m_cbTrueHD.Create (_T("TrueHD"), WS_VISIBLE|WS_CHILD|WS_TABSTOP|BS_AUTORADIOBUTTON|BS_TOP|BS_MULTILINE|WS_GROUP, CRect (LEFT_SPACING + 15,  nPosY, LEFT_SPACING + 15 + 90, nPosY+20), this, IDC_PP_TRUEHD);
