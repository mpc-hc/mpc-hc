...
static __inline ogg_int32_t vorbis_invsqlook_i(long a,long e){
...
/* a is in n.12 format */
static __inline ogg_int32_t vorbis_fromdBlook_i(long a){
...
static __inline ogg_int32_t vorbis_coslook_i(long a){
...
static __inline ogg_int32_t vorbis_coslook2_i(long a){
  a=a&0x1ffff;
...
static __inline ogg_int32_t toBARK(int n){
  int i;
  for(i=0;i<27;i++) 
