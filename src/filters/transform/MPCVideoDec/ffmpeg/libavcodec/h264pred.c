...
static void pred4x4_vertical_vp8_c(uint8_t *src, uint8_t *topright, int stride){
...
static void pred4x4_horizontal_vp8_c(uint8_t *src, uint8_t *topright, int stride){
    const int lt= src[-1-1*stride];
    LOAD_LEFT_EDGE
...
static void pred4x4_vertical_left_vp8_c(uint8_t *src, uint8_t *topright, int stride){
    LOAD_TOP_EDGE
    LOAD_TOP_RIGHT_EDGE
