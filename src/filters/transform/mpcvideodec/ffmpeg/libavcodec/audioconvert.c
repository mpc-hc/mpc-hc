...
#else
static SampleFmtInfo sample_fmt_info[SAMPLE_FMT_NB];

void sample_fmt_info_init(void)
{
	sample_fmt_info[SAMPLE_FMT_U8].name = "u8";	
	sample_fmt_info[SAMPLE_FMT_U8].bits = 8;
	sample_fmt_info[SAMPLE_FMT_S16].name = "s16";	
	sample_fmt_info[SAMPLE_FMT_S16].bits = 16;
	sample_fmt_info[SAMPLE_FMT_S32].name = "s32";	
	sample_fmt_info[SAMPLE_FMT_S32].bits = 32;
	sample_fmt_info[SAMPLE_FMT_FLT].name = "flt";	
	sample_fmt_info[SAMPLE_FMT_FLT].bits = 32;
	sample_fmt_info[SAMPLE_FMT_DBL].name = "dbl";	
	sample_fmt_info[SAMPLE_FMT_DBL].bits = 64;
}
#endif
