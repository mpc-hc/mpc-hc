...
STDMETHODIMP CDirectVobSubFilter::get_SubtitleOverlapping(bool* subtitleOverlapping)
{
    HRESULT hr = CDirectVobSub::get_SubtitleOverlapping(subtitleOverlapping);

    return hr;
}

STDMETHODIMP CDirectVobSubFilter::put_SubtitleOverlapping(bool subtitleOverlapping)
{
    HRESULT hr = CDirectVobSub::put_SubtitleOverlapping(subtitleOverlapping);
...
void CDirectVobSubFilter::SetSubtitle(ISubStream* pSubStream, bool fApplyDefStyle)
{
    ...
    if (pSubStream) {
        ...
        if (clsid == __uuidof(CVobSubFile)) {
            ...
            pRTS->SetSubtitleOverlapping(m_subtitleOverlapping);
