...
public:
    ...
    STSSegment()
        : start(0)
        , end(0) {}
    STSSegment(LONGLONG s, LONGLONG e) {
        start = s;
        end = e;
    }
...
public:
    ...
    void Append(CSimpleTextSubtitle& sts, LONGLONG timeoff = -1);
    ...
    void Add(CStringW str, bool fUnicode, LONGLONG start, LONGLONG end, CString style = _T("Default"), CString actor = _T(""), CString effect = _T(""), const CRect& marginRect = CRect(0, 0, 0, 0), int layer = 0, int readorder = -1);
    ...
    LONGLONG TranslateStart(int i, double fps);
    LONGLONG TranslateEnd(int i, double fps);
    int SearchSub(LONGLONG t, double fps);

    LONGLONG TranslateSegmentStart(int i, double fps);
    LONGLONG TranslateSegmentEnd(int i, double fps);
    const STSSegment* SearchSubs(LONGLONG t, double fps, /*[out]*/ int* iSegment = nullptr, int* nSegments = nullptr);
