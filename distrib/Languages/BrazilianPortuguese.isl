...
; Roger Felipe (rfrfrfrf@users.sourceforge.net)
...
; *** Misc. errors
ErrorCreatingDir=O Programa de Instalação não foi capaz de criar o diretório "%1"
ErrorTooManyFilesInDir=Incapaz de criar um arquivo no diretório "%1" porque ele contém arquivos em excesso
