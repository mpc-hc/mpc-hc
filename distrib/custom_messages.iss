...
en.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
en.msg_unsupported_cpu=This build of MPC-HC requires a CPU of type i686 or newer. Your CPU is not supported.
...
br.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
by.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
ca.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
cz.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
cz.msg_unsupported_cpu=Toto sestavení MPC-HC vyžaduje procesor i686 nebo novější. Váš procesor není podporován.
...
de.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
es.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
es.msg_unsupported_cpu=Esta versión de MPC-HC requiere una CPU i686 o posterior. Su CPU no es compatible.
...
fr.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
fr.msg_unsupported_cpu=Cette version de MPC-HC nécessite un CPU de type i686 ou plus récent. Votre CPU n'est plus supporté.
...
hu.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
it.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
ja.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
ja.msg_SetupIsRunningWarning=MPC-HC のインストーラーは既に実行されています！
ja.msg_simd_sse=このバージョンのMPC-HCはCPUのSSEサポートが必要です。お使いのCPUはこの条件を満たしません。
ja.msg_simd_sse2=このバージョンのMPC-HCはCPUのSSE2サポートが必要です。お使いのCPUはこの条件を満たしません。
...
kr.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
nl.msg_NoD3DX9DLL_found=De nieuwste DirectX runtime is niet geinstalleerd! %nGraag deze downloaden en installeren ongeacht je Windows versie.
...
pl.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
pl.msg_unsupported_cpu=Ta kompilacja MPC-HC wymaga procesora o architekturze i686 lub nowszej. Twój procesor nie jest obsługiwany.
...
ru.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
ru.msg_unsupported_cpu=Этот билд MPC-HC требует ЦПУ с архитектурой i686 или новее. Ваш ЦПУ не поддерживается.
...
sc.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
se.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
sk.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
tc.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
tc.msg_SetupIsRunningWarning=MPC-HC 安裝程式已在運行中!
tc.msg_simd_sse=此版的 MPC-HC 需要有支援 SSE 指令集的 CPU. 您的 CPU 並未相容這些功能.
tc.msg_simd_sse2=此版的 MPC-HC 須要有支援 SSE2 指令集的 CPU. 您的 CPU 並未相容這些功能.
tc.msg_unsupported_cpu=此版的 MPC-HC 需要 i686 或更新種類的 CPU. 您的 CPU 並不支援.
...
tr.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
ua.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %nPlease download and install it regardless of your operating system.
...
ua.msg_unsupported_cpu=Для використання даної версії MPC-HC необхідно, щоб ваш процесор був i686 типу або новіший. Ваш процесор не підтримується.
