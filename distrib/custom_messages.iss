...
en.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %n%nPlease download and install the latest DirectX runtime ({#DXSDK_Date}) regardless of your operating system.
...
br.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %n%nPlease download and install the latest DirectX runtime ({#DXSDK_Date}) regardless of your operating system.
...
cz.msg_NoD3DX9DLL_found=Nainstalovaná verze DirectX není dostatečně aktuální! %n%nStáhněte a nainstalujte nejnovější aktualizaci DirectX ({#DXSDK_Date}). %n%nPozor, aktualizace je pro všechny verze DirectX, nejen pro DirectX 9!
...
fr.msg_NoD3DX9DLL_found=La dernière version des composants d'exécution DirectX n'est pas installée ! %nCelle-ci est nécessaire quel que soit votre système d'exploitation, veuillez la télécharger et l'installer ({#DXSDK_Date}).
...
hu.msg_NoD3DX9DLL_found=A legújabb DirectX nincs telepítve! %n%nKérjük töltse le és telepítse a legújabb DirectX runtime ({#DXSDK_Date}) verziót függetlenül az operációs rendszerétől.
...
ja.msg_NoD3DX9DLL_found=最新の DirectX ランタイムはインストールされません！%n%nオペレーティングシステムにかかわらず最新の DirectX ランタイム ({#DXSDK_Date}) をダウンロードして、インストールしてください。
ja.msg_SetupIsRunningWarning=MPC-HC のインストーラーは既に実行されています！
ja.msg_simd_sse=このバージョンの MPC-HC は CPU の SSE サポートが必要です。お使いの CPU はこの条件を満たしません。
ja.msg_simd_sse2=このバージョンの MPC-HC は CPU の SSE2 サポートが必要です。お使いの CPU はこの条件を満たしません。
ja.msg_unsupported_cpu=このバージョンの MPC-HC は i686 CPU が必要です。お使いの CPU はサポートされません。
...
nl.msg_NoD3DX9DLL_found=De nieuwste DirectX runtime is niet geinstalleerd! %n%nGraag de nieuwste DirectX runtime ({#DXSDK_Date}) downloaden en installeren ongeacht je windows versie.
...
ru.msg_NoD3DX9DLL_found=The latest DirectX runtime is not installed! %n%nPlease download and install the latest DirectX runtime ({#DXSDK_Date}) regardless of your operating system.
...
sc.msg_NoD3DX9DLL_found=还没安装最新版本的 DirectX 运行库! %n%n不论您所使用的作业系统请下载及更新至最新版本的 DirectX 运行库 ({#DXSDK_Date})。
...
sc.msg_unsupported_cpu=这个编译版的 MPC-HC 需要 i686 或更新种类的 CPU。但是您的 CPU 并不支持。
...
tc.msg_NoD3DX9DLL_found=未安裝最新版本的 DirectX Runtime！%n%n不論您使用的作業系統為何，請下載並更新至最新版本的 DirectX Runtime ({#DXSDK_Date})。
tc.msg_SetupIsRunningWarning=已在執行 MPC-HC 安裝程式！
tc.msg_simd_sse=此版的 MPC-HC 需要有支援 SSE 延伸指令集的 CPU。您的 CPU 並未相容這些功能。
tc.msg_simd_sse2=此版的 MPC-HC 須要有支援 SSE2 延伸指令集的 CPU。您的 CPU 並未相容這些功能。
tc.msg_unsupported_cpu=此版的 MPC-HC 需要 i686 或更新的 CPU 類型。您的 CPU 並不支援。
...
ua.msg_NoD3DX9DLL_found=Останню версію DirectX не встановлено! %n%nБудь ласка, завантажте і встановіть останню версію DirectX ({#DXSDK_Date}) відповідно до операційної системи, яку ви використовуєте.
