...
pt.langid=00000017
pt.tsk_AllUsers=For all users
pt.tsk_CurrentUser=For the current user only
pt.tsk_Other=Other tasks:
pt.tsk_ResetSettings=Reset settings
