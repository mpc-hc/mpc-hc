...
br.msg_NoD3DX9DLL_found=A ultima versao do DirectX não está instalada! %n%nFavor baixe e instale a ultima versão ({#DIRECTX_SDK_DATE}) independente do seu sistema operacional.
...
br.msg_simd_sse2=Esta versão do MPC-HC necessita uma CPU com suporte a extensões SSE 2. Sua CPU não tem esse suporte.
...
br.ViewChangelog=Ver alterações
